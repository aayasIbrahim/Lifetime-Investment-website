...
export default function BenfitsCards({img, title, description}) {
  return (
    <div class=" gap-[10px] rotate-0 opacity-100 ps-[40px]  rounded-[20px] border-[5px] border-[#87CEEC] pointer hover:bg-[linear-gradient(90deg,_#87CEEC,_#01BEFE,_#1E90FF)]">
