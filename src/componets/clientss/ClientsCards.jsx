...
export default function ClientsCards({image, country, description, name}) {
  return (
    <div className="flex flex-col justify-center items-center  gap-[20px] rounded-[10px] border-[5px] border-[#1E90FF] ">
      ...
      <p className="text-[22px] leading-[34px] font-normal text-center mt-[10px]">{country}</p>
      <p
        class="text-[22px] leading-[34px] font-normal text-center mt-[20px] mb-[60px]"
      >
        {description}
      </p>
    </div>
